...
2. ASCII编码：American Standard Code for information Interchange，美国信息交换标准码。那为什么存储单位是8位呢？**因为8位可以存储所有ASCII所有字符（这是它包含8bits的初衷）**。因为这套编码系统是美国统一的标准，对美国人来说；所有字符包括单词，标点符号都全部都囊括进了这128（0~127）个字符，美国人用完全就够了。
...
[ASCII](https://zh.wikipedia.org/wiki/ASCII)编码：**American Standard Code for information Interchange（美国信息交换标准码）**。

> ASCII码：是7位，但存储依旧是8位存储。
>
> 
