...
public extension Observable {
    ...
    static func from(_ optional: Element?) -> Observable<Element> {
    ...
    static func from(_ optional: Element?, scheduler: ImmediateSchedulerType) -> Observable<Element> {
...
public extension ObservableType {
    ...
    func mapWithIndex<Result>(_ selector: @escaping (Element, Int) throws -> Result)
        -> Observable<Result>
    {
    ...
    func flatMapWithIndex<Source: ObservableConvertibleType>(_ selector: @escaping (Element, Int) throws -> Source)
    ...
    func skipWhileWithIndex(_ predicate: @escaping (Element, Int) throws -> Bool) -> Observable<Element> {
    ...
    func takeWhileWithIndex(_ predicate: @escaping (Element, Int) throws -> Bool) -> Observable<Element> {
...
public extension ObservableType {
    ...
    func delay(_ dueTime: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType {
    ...
    func timeout(_ dueTime: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
    ...
    func timeout<OtherSource: ObservableConvertibleType>(_ dueTime: Foundation.TimeInterval, other: OtherSource, scheduler: SchedulerType)
...
public extension ObservableType {
    ...
    func skip(_ duration: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType where Element: RxAbstractInteger {
    ...
    static func interval(_ period: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType where Element: RxAbstractInteger {
    ...
    static func timer(_ dueTime: Foundation.TimeInterval, period: Foundation.TimeInterval? = nil, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType {
    ...
    func throttle(_ dueTime: Foundation.TimeInterval, latest: Bool = true, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType {
    ...
    func take(_ duration: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType {
    ...
    func delaySubscription(_ dueTime: Foundation.TimeInterval, scheduler: SchedulerType)
        -> Observable<Element>
    {
...
public extension ObservableType {
    ...
    func window(timeSpan: Foundation.TimeInterval, count: Int, scheduler: SchedulerType)
...
public extension PrimitiveSequence {
     ...
     */
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timeout(_:other:scheduler:)")
    func timeout(_ dueTime: Foundation.TimeInterval,
...
public extension PrimitiveSequenceType where Trait == SingleTrait {
    ...
    func `do`(onNext: ((Element) throws -> Void)?,
...
public extension ObservableType {
    ...
    func buffer(timeSpan: Foundation.TimeInterval, count: Int, scheduler: SchedulerType)
        -> Observable<[Element]>
    {
...
public extension PrimitiveSequenceType where Element: RxAbstractInteger {
    ...
    static func timer(_ dueTime: Foundation.TimeInterval, scheduler: SchedulerType)
        -> PrimitiveSequence<Trait, Element>
    {
...
public extension Completable {
    ...
    static func merge<Collection: Swift.Collection>(_ sources: Collection) -> Completable
